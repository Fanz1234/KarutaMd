...
const boom1 = JSON.parse(fs.readFileSync(`./database/user/boom1.json`))
let autoai = JSON.parse(fs.readFileSync('./database/user/autoai.json'));
...
const isAutoai = autoai.includes(m.sender)
...
const karutamddd = await reSize(`./karuta/webpmobile.jpg`, 200, 200) 
const ftex = {
	 key: { 
fromMe: false,
...
message: { 
"liveLocationMessage": {
degreesLatitude: -6.9181,
degreesLongitude: 106.9267,
...
"productImage":{
"mimetype": "image/jpeg",
"jpegThumbnail": karutamddd //The picture
},
"title": `${ucapanWaktu} ${pushname}`, 
"description": `${ucapanWaktu} ${pushname}`, 
"currencyCode": "USD",
"priceAmount1000": "2000",
"retailerId": `Kitsune Md`,
"productImageCount": 1
},
...
/// BASE TEBAK BOOM BY RIMURU
/// COLONG? TAMBAH NAMA GW DI TQTQ :)
if (isBoom) {
try {
bom = "1"
...
footer: `*${setting.footer}*\n© bit.ly/yukishima`,
 ...
 naimi.sendMessage(from, buttonMessageg, { quoted: m })
...
if (budy == '1') {
if(boom[i].bom1 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '2') {
if(boom[i].bom2 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '3') {
if(boom[i].bom3 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '4') {
if(boom[i].bom4 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '5') {
if(boom[i].bom5 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '6') {
if(boom[i].bom6 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '7') {
if(boom[i].bom7 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '8') {
if(boom[i].bom8 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
if (budy == '9') {
if(boom[i].bom9 == true) return reply("Nomor tersebut sudah anda pilih sebelumnya pilih nomor lain")
...
naimi.sendMessage(from, patri9, {quoted:ftroli})
}
}
break
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
if (isBan) return reply(mess.banned)
if (isBoom) return reply(`Kamu sudah bermain tebak bom sebelumnya selesaikan dulu!`)
if (q  === 'mulai') {
 if ( checkuangUser(sender) <= 500) return reply(`maaf kak uang nya gak cukup, kumpulin uang nya dulu >_< `)
...
naimi.sendMessage(from, buttonMessageg, { quoted: ftroli })}
}
break
case 'udahanbom':{
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if (!isBoom) return reply(`Kamu tidak berada di sesi tebak bom`)
Object.keys(boom).forEach((i) => {
const bomzzz = {id: sender, bom1 : boom[i].bom1, bom2 : boom[i].bom2, bom3 : boom[i].bom3, bom4 : boom[i].bom4, bom5 : boom[i].bom5, bom6 : boom[i].bom6, bom7 : boom[i].bom7, bom8 : boom[i].bom8, bom9 : boom[i].bom9,bomnya : boom[i].bomnya} 
setTimeout( () => {
anuk = boom1.indexOf(sender)
...
boom.splice(bomzzz, 1)
fs.writeFileSync('./database/user/boom.json', JSON.stringify(boom))
reply(`Berhasil menghentikan tebak bom uang anda hangus!`)
}, 2000)
})
}
break
...
•Saya Bukan wibu :v`
naimi.sendMessage(m.chat, { video: { url:'https://www.filezone.cf/file/lgu8w54k5sty4xt0g5n1.mp4' }, gifPlayback: true , caption:pro}, { quoted: fpoll })
break
case 'menu':
case 'list':
case 'help':
